...
public class PasswordQuestion {
   ...
   // sifreyi kullanicidan tekrar tekrar istememiz gerekebilir diye loop un icinde isteyelim
        String sifre =" "; // sartları sağlamayan bir ilk deger ataması yaptık
        // loop umuz sifre basarılı olmadıgı sürece olusmaya devam edecek;
