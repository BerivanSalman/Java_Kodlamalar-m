...
public class Substring {
    public static void main(String[] args) {
        ...
        System.out.println("bas indexi ve bitis indexi ayni olursa:"+ str.substring(5,5)+"---"); // "" HİÇLİK yazdırır.
        // E den basla ama e dahil olmasın diyor o yüzden elimizde hiçbirsey kalmaz
