...
public class EqualsIgnoreCase {
    public static void main(String[] args) {
      ...
      Scanner scanner = new Scanner(System.in);
        ...
        // ignorecase ile String'leri buyuk kucuk harf gozetmeksizin karsilastirabiliriz
        String harf = girilenHarf +"";// char'ı stringlestirmek icin "" kullanırız. Neden stringlestiririz? char da equalsignorecase metodu yok
