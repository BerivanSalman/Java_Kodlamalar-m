...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        ElemanVarMıKacKereKullanıldı.elemanSayisiYazdir(arr,5); // Aranan eleman array'de yok
        // arr'de 3'in olup olmadigini ve varsa kac tane oldugunu yazdirin
        ElemanVarMıKacKereKullanıldı.elemanSayisiYazdir(arr,3); // Aranan eleman array'de 2 kere kullanilmis
        System.out.println("========");
        ...
        Arrays.sort(isimler); // isimleri sıralar
        System.out.println(Arrays.toString(isimler)); //sıralanan isimler: [Azim, Azim, Esra, Huseyin, Ibrahim, Omer]
