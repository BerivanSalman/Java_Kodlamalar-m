...
public class Lesson2 {
    public static void main(String[] args) {
        /*
            ...
            method signature olusur. Orn; toplama int int
    ...
    public static void toplama(int sayi1 , int sayi2){ // toplama int int (sıgnaturesi budur)
        System.out.println("Iki int sayinin toplami : " + (sayi1+sayi2));
    }
    // verilen iki integer sayiyi toplayip yazdiran bir method olusturun
    public static void toplama(int a , double b){ // toplama int double(sıgnaturesi budur)
