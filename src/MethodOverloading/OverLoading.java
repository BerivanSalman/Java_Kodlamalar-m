...
public class OverLoading {
    public static void main(String[] args) {
        ...
        //İkisi de str'ın substringini getirir ama farklı seyler getirir. Cunku ilkinde ve ikincisinde
        //verilen parametre sayisi farklıdır.Yani Java hangi method'u kullanacagina
        // method call sirasinda yazacagimiz argument'lere (parametrelere) gore karar verir
