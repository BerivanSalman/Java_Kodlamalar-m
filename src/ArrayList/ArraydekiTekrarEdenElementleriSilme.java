...
public class ArraydekiTekrarEdenElementleriSilme {
    public static void main(String[] args) {
        ...
        int[] yeniArr = new int[uniqueList.size()]; //listte length methodu yok size methodu var
        ...
        for (int i = 0; i < yeniArr.length ; i++) {
            ...
            //uniqueList'ten i. elemanı getir ben de arrayin i. indexine onu atayayım
        }
        // yeni array'i de eski array'e deger olarak atayalim;
        arr = yeniArr ;
        Arrays.sort(arr); // kucukten buyuge kadar yazar hepsini
