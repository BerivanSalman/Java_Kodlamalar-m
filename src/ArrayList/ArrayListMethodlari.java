...
public class ArrayListMethodlari {
    public static void main(String[] args) {
        List<Integer> sayilar = new ArrayList<>();
        System.out.println(sayilar); // []
        System.out.println(sayilar.size()); // 0
        System.out.println("Liste bos mu : " + sayilar.isEmpty()); //true
        sayilar.add(5);
        sayilar.add(0,7);
        System.out.println(sayilar); // [7, 5]
        System.out.println(sayilar.size()); // 2
        System.out.println("Liste bos mu : " + sayilar.isEmpty()); //false
        ...
        isimler.add("Levent");
        isimler.add("Esra");
        //get ; istidiğimiz indexteki elemanları getirir
        System.out.println(isimler.get(0));//0. indexteki elemanı getir
