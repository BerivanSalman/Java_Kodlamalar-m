...
public class SetMethodu {
    public static void main(String[] args) {
        ...
        isimler.set(3,"Gulnur"); //Azim gitsin gulnur gelsin
        ...
        System.out.println(isimler.set(2, "Yusuf"));  // Esra yazdırır. yani 2. indexteki esrayı sildim demek istiyor
