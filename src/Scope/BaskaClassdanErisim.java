...
public class BaskaClassdanErisim {
    /*
    ...
    public static void main(String[] args) {
        System.out.println(Scope_ClassVariables.bl); // true
        System.out.println(Scope_ClassVariables.chr); // a
        Scope_ClassVariables.staticMethod();
        Scope_ClassVariables obj = new Scope_ClassVariables();
