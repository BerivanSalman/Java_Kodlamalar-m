...
public class NestedMapOlusturma {
    public static void main(String[] args) {
        ...
        //Value yeni bir maptir. Ogrenci map ı olusturmak istedigimizde once alt map i olusturmamız gerek

        // ogrenci map'i {101=ogrMap101 , 102=ogrMap102, 103=ogrMap103}
        Map<Integer , Map<String,String>> ogrenciMap = new HashMap<>(); // Outer Map. Asıl okul map in key i integer. Valuesi Map. Bu map de stringlerden olusur
        //key integer    Burda ogrenci mapinin key ve valuesi Stringdir. İsim= Ali gibi
        ...
        ogrenciMap.put(101,ogrMap101); //key 101, value: ofrMap101
        ...
        //Normalde 102 numaralı ogrencinin valuesini alacaktık o string olacaktı. Sonra split edecektik.Split ettikten sonra da indexleri alacaktık
