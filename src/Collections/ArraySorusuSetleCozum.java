...
public class ArraySorusuSetleCozum {
    public static void main(String[] args) {
        ...
        System.out.println("Set : " + tekrarsizSet); // Set : [1, 2, 4, 5, 6, 7, 8, 9] hem sıralı koydu hem de tekrar edenleri sildi
        //Bunu arraye cevirelim
